...
local Utility = {}
local Objects = {}
function loaring:DraggingEnabled(frame, parent)
...
function loaring.CreateLib(kavName, themeList)
    ...
    loaring:DraggingEnabled(MainHeader, Main)
    ...
    function loaring:ChangeColor(prope,color)
